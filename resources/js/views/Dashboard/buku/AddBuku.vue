<template>
  <main class="flex-1 pb-8">
    ...
    <form class="py-6 px-9" v-on:submit.prevent="addBook">
      ...
      <div class="mb-5">
        ...
        <select
          ...
          "
        >
          <option selected>Choose a bookshelf</option>
          <option
...
export default {
  ...
  methods: {
    ...
    addBook() {
      ...
      formData.append("bookshelves_id", this.book.bookshelves_id);
